...
\begin{longtable}{|p{.08\textwidth}|p{.25\textwidth} |p{.25\textwidth}|p{.30\textwidth}| }
	...
	\hline
	4.&$\rotation\vec{B}=\nabla\times\vec{B}=\mu_0 (J+\frac{\partial \vec{D}}{\partial t})$&$\rotation \vec{H}=\nabla \times \vec{H}=\sigma\vec{E}+\epsilon \frac{\partial \vec{E}}{\partial t}$&$\oint\limits_{\partial A} \vec{H}\cdot ds$\\
	\hline
\end{longtable}
...
\begin{tabular}{p{.45\textwidth} p{.45\textwidth}}
	...
	Das E-Feld ist ein Quellenfeld. Die Ladung ist die Quelle des elektrischen Feldes. & Der elektrische Fluss durch die geschlossene Oberfläche eines Volumen ist direkt proportional zur elektrischen Ladung in seinem inneren. \\
\end{tabular}
...
\begin{minipage}{8cm}
	...
	\rotation \vec{E}=-\mu\dfrac{\partial \vec{H}}{\partial t}
	\end{matrix}\]
\end{minipage}
\begin{minipage}{8cm}
